...
tuple<int, int, vector<ii>> postProcess(int n, vector<ii> e){
	e = modify(n, e);
	int r = getRandInt(1, n);
	return {n, r, e};
}

void print(const tuple<int, int, vector<ii>> &t){
	auto [n, r, e] = t;
	cout << n << " " << r << "\n";
...
const string types[] = {"randomTree", "lineTree", "starTree", "stretchTree", "highdegTree", "kTree", "caterpillarTree", "starlineTree"};
